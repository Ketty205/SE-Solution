...
def get_load_data_from_entsoe(regions, periodStart='2022-01-01', periodEnd='2023-01-01', output_path='C:/Users/pc/Desktop/podaci'):

    #output_path is specific path for folder in local computer, where I stored all download file 

    if not os.path.exists('C:/Users/pc/Desktop/podaci'):
        os.makedirs('C:/Users/pc/Desktop/podaci')
...
def get_gen_data_from_entsoe(regions, periodStart='2022-01-01', periodEnd='2023-01-01', output_path='C:/Users/pc/Desktop/podaci'):
    if not os.path.exists('C:/Users/pc/Desktop/podaci'):
        os.makedirs('C:/Users/pc/Desktop/podaci')
...
def parse_arguments():
    ...
    parser.add_argument(
        '--output_path', 
        type=str, 
        default='C:/Users/pc/Desktop/podaci',
